...
test_final_integration.py::test_mission_planning PASSED                  [ 17%]
test_final_integration.py::test_mission_execution PASSED                 [ 18%]
test_final_integration.py::test_mission_reporting PASSED                 [ 20%]
test_imports.py::test_imports PASSED                                     [ 21%]
test_integration.py::test_progress_imports PASSED                        [ 22%]
test_integration.py::test_jax_fallback PASSED                            [ 24%]
test_integration.py::test_virtual_control_loop PASSED                    [ 25%]
test_integration.py::test_analog_simulation PASSED                       [ 27%]
test_integration.py::test_jax_optimization PASSED                        [ 28%]
test_integration.py::test_progress_tracker_direct PASSED                 [ 29%]
test_integration.py::test_impulse_engine_simulation PASSED               [ 31%]
test_integration.py::test_vector_impulse_simulation PASSED               [ 32%]
test_integration.py::test_rotation_simulation PASSED                     [ 33%]
test_integration.py::test_integrated_control_system PASSED               [ 35%]
test_integration.py::test_simulation_integration PASSED                  [ 36%]
test_jax_acceleration.py::test_einstein_tensor_computation PASSED        [ 37%]
test_jax_acceleration.py::test_trajectory_simulation PASSED              [ 39%]
test_jax_acceleration.py::test_stress_energy_computation PASSED          [ 40%]
test_jax_gpu.py::test_jax_gpu PASSED                                     [ 41%]
test_mvp_integration.py::test_mvp_components PASSED                      [ 43%]
test_repository.py::TestBasicImports::test_core_module_import PASSED     [ 44%]
test_repository.py::TestBasicImports::test_field_algebra_import PASSED   [ 45%]
test_repository.py::TestBasicImports::test_metrics_import PASSED         [ 47%]
test_repository.py::TestBasicImports::test_optimization_imports PASSED   [ 48%]
test_repository.py::TestNumericalCalculations::test_van_den_broeck_calculation PASSED [ 50%]
test_repository.py::TestNumericalCalculations::test_basic_numpy_operations PASSED [ 51%]
test_repository.py::TestOptimizationTools::test_simple_optimization PASSED [ 52%]
test_repository.py::TestOptimizationTools::test_ansatz_optimizer_creation PASSED [ 54%]
test_repository.py::TestIntegrationUtilities::test_basic_integration PASSED [ 55%]
test_repository.py::TestIntegrationUtilities::test_energy_integration PASSED [ 56%]
test_repository.py::TestAnsatzDevelopment::test_ansatz_builder PASSED    [ 58%]
test_repository.py::TestAnsatzDevelopment::test_novel_ansatz_creation PASSED [ 59%]
test_repository.py::TestDemoScripts::test_demo_metric_optimization_syntax PASSED [ 60%]
test_repository.py::TestDemoScripts::test_advanced_demo_syntax PASSED    [ 62%]
test_repository.py::TestRepositoryStructure::test_src_directory_structure PASSED [ 63%]
test_repository.py::TestRepositoryStructure::test_docs_directory PASSED  [ 64%]
test_repository.py::TestRepositoryStructure::test_essential_files PASSED [ 66%]
test_repository.py::TestRepositoryStructure::test_demo_scripts_exist PASSED [ 67%]
test_repository.py::test_integration_workflow PASSED                     [ 68%]
test_setup.py::test_basic_imports PASSED                                 [ 70%]
test_setup.py::test_basic_functionality PASSED                           [ 71%]
test_simple_integration.py::test_simple PASSED                           [ 72%]
tests/test_field_and_control.py::test_zero_expansion_metric PASSED       [ 74%]
tests/test_field_and_control.py::test_ring_sync_tolerance PASSED         [ 75%]
tests/test_field_and_control.py::test_coil_driver_linearity PASSED       [ 77%]
tests/test_field_and_control.py::test_plasma_density_shell_profile PASSED [ 78%]
tests/test_field_and_control.py::test_field_synthesis_envelope_bounds PASSED [ 79%]
tests/test_field_and_control.py::test_envelope_fit_error_monotonicity_uniform PASSED [ 81%]
tests/test_field_and_control.py::test_tune_ring_amplitudes_uniform_returns_best_controls PASSED [ 82%]
tests/test_field_and_control.py::test_envelope_to_shift_coupling_divergence_small PASSED [ 83%]
tests/test_field_and_control.py::test_optimize_energy_stub_outputs PASSED [ 85%]
tests/test_field_and_control.py::test_battery_feasibility_flag PASSED    [ 86%]
tests/test_field_and_control.py::test_zero_expansion_tolerance_vs_resolution PASSED [ 87%]
tests/test_field_and_control.py::test_discharge_efficiency_affects_feasibility PASSED [ 89%]
tests/test_power_profile.py::test_energy_increases_with_ramp_duration PASSED [ 90%]
tests/test_power_profile.py::test_numerical_values_match_analysis PASSED [ 91%]
tests/test_power_profile.py::test_invalid_inputs PASSED                  [ 93%]
tests/test_power_profile.py::test_triangle_shape_equivalence PASSED      [ 94%]
tests/test_vnv_natario_build_metric.py::test_build_metric_divergence_free PASSED [ 95%]
